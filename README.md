...
8. **Fix common Windows packaging errors (`icons` / `package.metadata`):**
   ...
   ```powershell
   # Generates src-tauri/icons/*.png from public/icon-light-32x32.png
   pnpm tauri:icons
   ...
   - The `package.metadata does not exist` line is usually informational; missing icon assets are the real blocker.
   - This repo intentionally does **not** commit generated icon binaries to keep Codex PR creation compatible.
